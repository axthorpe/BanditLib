...
class User():
	...
	def setArticleList(self, articlesList):
...
class UserManager():
	...
	def simulateThetafromUsers(self):
		...
		for i in range(self.userNum):
			...
			#userFeature = self.thetaFunc(self.dimension, argv = self.argv)
			#userFeature_l2_norm = np.linalg.norm(userFeature, ord =2) 
		...
		#userFeature = userFeature.tolist()
		#print userFeature
